#' @title Triple Exponential (Mixed) Multiplicative Smoothing - Holt-Winters algorithm
#'
...
#' 
#' @seealso sma, wma, naive, ses, ma, tes, ddes, dtes, lrtp, tes_add, dtes_add, dtes_mult
#' 
...
#' tes_mult(d=dTest6,fp=4)
#' ## Run for 5 future periods
#' tes_mult(d=dTest6, fp=4, future=5)
#' ## Run with other parameter values
#' tes_mult(d=dTest6, fp=4, future=5, alpha=0.6, beta=0.5, gamma=0.2)
#' ## Run with non default initialization values for level and trend
#' tes_mult(d=dTest6, fp=4, alpha=0.6, beta=0.5, gamma=0.2, future=5, a0=400, b0=110)
#' 
#' @export
tes_mult <- function(d, fp=NaN, alpha=0.3, beta=0.2, gamma=0.1, future=1, a0=NaN, b0=NaN){
